...
load_cfg(dirname, "anynet_cfg.yaml")
...
class VanillaBlock(nn.Module):
    ...
    def __init__(self, w_in, w_out, stride, bm=None, g=None):
        ...
        self._construct_model(w_in, w_out, stride)

    def _construct_model(self, w_in, w_out, stride):
        # 3x3, BN, ReLU
        self.a = nn.Conv2d(
...
class BottleneckTransform(nn.Module):
    ...
    def __init__(self, w_in, w_out, stride, bm, g):
        ...
        self._construct_model(w_in, w_out, stride, bm, g)

    def _construct_model(self, w_in, w_out, stride, bm, g):
...
class ResStemCifar(nn.Module):
    ...
    def __init__(self, w_in, w_out):
        ...
        self._construct_model(w_in, w_out)

    def _construct_model(self, w_in, w_out):
        # 3x3, BN, ReLU
        self.conv = nn.Conv2d(
...
class SimpleStemIN(nn.Module):
    ...
    def __init__(self, in_w, out_w):
        ...
        self._construct_model(in_w, out_w)

    def _construct_model(self, in_w, out_w):
        # 3x3, BN, ReLU
        self.conv = nn.Conv2d(
...
class AnyStage(nn.Module):
    ...
    def __init__(self, w_in, w_out, stride, d, block_fun, bm, g):
        ...
        self._construct_model(w_in, w_out, stride, d, block_fun, bm, g)

    def _construct_model(self, w_in, w_out, stride, d, block_fun, bm, g):
